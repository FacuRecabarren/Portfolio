...
const Projects = () => {
    ...
    const projects = [
        {id: 0, name: "Atom Gym", description: i18n.language === "en" ? "Web page project for gyms where users can view exercises by muscle groups without registering. Registered users can create and edit routines. It also includes an administration section for managing payments and users." : "Proyecto de página web para gimnasios donde los usuarios pueden ver ejercicios por grupos musculares sin registrarse. Los usuarios registrados pueden crear y editar rutinas. También incluye una sección de administración para gestionar pagos y usuarios.", image: "https://res.cloudinary.com/dreso9ye9/image/upload/v1721408253/Portfolio%20FR/localhost_5173__Nest_Hub_Max_ppl8v3.png", repository: <a href="https://github.com/FacuRecabarren/Atom-Gym" target="_blank" className="bg-palette-600 hover:opacity-80 py-2 px-10 rounded-lg text-xl xl:text-2xl transform hover:scale-105 duration-300 shadow-sombra-btn-proyects cursor-pointer" rel="noreferrer"><FaGithub/></a>, languages: <><FaReact/><SiExpress/><FaNodeJs/><SiRedux/><SiTailwindcss/><SiSequelize/><SiPostgresql/></>},
